...
import { useIntl, IntlProvider as LibIntlProvider } from "react-intl";
import type { PrimitiveType } from "intl-messageformat";

// "import type" ensures en messages aren't bundled by default
import type * as sourceOfTruth from "./en.json";
...
export function importMessages(locale: SupportedLocales): Promise<LocaleMessages> {
  switch (locale) {
    case "en":
...
export const IntlProvider: React.FC<
  Omit<React.ComponentProps<typeof LibIntlProvider>, "messages"> & {
    messages: LocaleMessages;
  }
> = (props) => <LibIntlProvider {...props} />;
